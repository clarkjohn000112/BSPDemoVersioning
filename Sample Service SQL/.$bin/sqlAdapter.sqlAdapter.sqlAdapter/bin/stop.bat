...
set INSTANCES_HOME=C:\E2E Documentation\Sample Service SQL\.$bin
set INSTANCE_HOME=C:\E2E Documentation\Sample Service SQL\.$bin\sqlAdapter.sqlAdapter.sqlAdapter
