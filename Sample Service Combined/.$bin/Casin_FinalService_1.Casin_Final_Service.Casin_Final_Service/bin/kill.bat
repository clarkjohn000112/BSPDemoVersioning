...
set INSTANCES_HOME=C:\E2E Documentation\Sample Service Combined\.$bin
set INSTANCE_HOME=C:\E2E Documentation\Sample Service Combined\.$bin\Casin_FinalService_1.Casin_Final_Service.Casin_Final_Service
